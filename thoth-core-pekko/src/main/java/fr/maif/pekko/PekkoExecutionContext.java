...
public class PekkoExecutionContext implements ExecutorService {

    private ExecutorService executor;

    public PekkoExecutionContext(ActorSystem system, String name) {
    ...
    public static PekkoExecutionContext createDefault(ActorSystem system) {
        return new PekkoExecutionContext(system, "jdbc-execution-context");
    }
