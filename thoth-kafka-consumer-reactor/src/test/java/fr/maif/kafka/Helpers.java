    ...
    public static class VikingEventFormat implements JacksonEventFormat<String, VikingEvent> {
        ...
        public Either<String, VikingEvent> read(String type, Long version, JsonNode json) {
            return Match(API.Tuple(type, version))
                    .option(
                            Case(VikingEvent.VikingCreatedV1.pattern2(), (t, v) -> Json.fromJson(json, VikingEvent.VikingCreated.class).get()),
                            Case(VikingEvent.VikingUpdatedV1.pattern2(), (t, v) -> Json.fromJson(json, VikingEvent.VikingUpdated.class).get()),
                            Case(VikingEvent.VikingDeletedV1.pattern2(), (t, v) -> Json.fromJson(json, VikingEvent.VikingDeleted.class).get())
                    )
    ...
    public static class VikingEventJsonFormat implements EventEnvelopeJsonFormat<VikingEvent, Tuple0, Tuple0> {
        ...
        public List<Tuple2<Type<? extends VikingEvent>, JsonRead<? extends VikingEvent>>> cases() {
            return List(
                ...
                Tuple(VikingEvent.VikingDeletedV1, ofRead(_fromClass(VikingEvent.VikingDeleted.class), JsonSchema.objectSchema()).description("VikingDeleted"))
            );
        }
